...
class SystemTrayManager:
    def __init__(self, main_window, toggle_callback=None):
        ...
        self.tray.setToolTip(f"PrimeDictate - {t('Sistem Geneli Sesli Yazma')}")
    ...
    def _setup_menu(self):
        ...
        self.show_action = menu.addAction(t("Kontrol Paneli"))
        self.show_action.triggered.connect(self.main_window.show_and_raise)

        self.toggle_action = menu.addAction(t("Dikteyi Başlat / Durdur"))
        if self.toggle_callback:
            self.toggle_action.triggered.connect(self.toggle_callback)

        menu.addSeparator()

        self.exit_action = menu.addAction(t("Çıkış"))
    ...
    def retranslate(self):
        self.tray.setToolTip(f"PrimeDictate - {t('Sistem Geneli Sesli Yazma')}")
        self.show_action.setText(t("Kontrol Paneli"))
        self.toggle_action.setText(t("Dikteyi Başlat / Durdur"))
        self.exit_action.setText(t("Çıkış"))
